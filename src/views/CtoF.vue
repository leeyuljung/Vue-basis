<template>
    <div class="container">
        ...
        <div class="toggle">
            <button @click="isCelsius = !isCelsius">切換</button>
        </div>
        ...
        <div class="inputArea">
            ...
            <input type="number" v-model="temperatureInput"> 度
        </div>

        <!-- show convert result -->
        <div class="showResult">
            <span v-if="isCelsius">華氏 {{ fahrenheit }} °F</span>
            <span v-if="!isCelsius">攝氏 {{ celsius }} °C</span>
        </div>
    </div>
</template>
